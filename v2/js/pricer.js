$(window).load(function() {
    ...
    data: {
        ...
        var for_labels_eur_light = Math.ceil((base/eurRate)*16);
        var for_labels_eur_basic = Math.ceil((base/eurRate)*19);
        var for_labels_eur_standart = Math.ceil((base/eurRate)*22);
        var for_labels_eur_premium = Math.ceil((base/eurRate)*25);
        ...
        var for_artists_eur_basic = Math.ceil(base/eurRate);
    ...
    $.ajax({
        ...
        //dataType: 'json'
            ...
            // BYN is static
            console.log('BYN tariff today is: ' + base);
            ...
            var for_artists_byn_basic = base;
