...
<body>
		...
		<div class="row">
			...
			<nav id="nav-wrap">         
				...
				<ul id="nav" class="nav">
					...
					<li><a class="smoothscroll color-o" href="#getfreedemo">Get Free demo.</a></li>
					...
					<ul class="slides">
						...
						<li>
						   <div class="flex-caption">
								<h1 class=""><span class="color-g">SLEDGER</span>&nbsp;MASTERING</h1>	
									
								<h3 class="">Mastering & STEM-mastering services for labels, distributors and artists.</h3>				   
							</div>						
						</li>
						...
						<li>						
							<div class="flex-caption">
								<h1 class=""><span class="color-g">BEST</span>&nbsp;PRICES</h1>
								<h3 class="">We made the best price system and we have a flexible discount system for you.</h3>			   
							</div>					
						</li>
						...
						<li>
							<div class="flex-caption">
								<h1 class=""><span class="color-g">FREE</span>&nbsp;DEMO</h1>
								<h3 class="">You can try our sounding for free (can be not-full version or full mp3 version).</h3>			   
							</div>
						</li>					              
						...
						<li>
						   <div class="flex-caption">
								<h1 class="">CHEAP&nbsp;&&nbsp;<span class="color-g">FAST</span></h1>

								<h3 class="">We think about music and sound quality as a one whole thing and we work on the principle of quickly and profitably for you.</h3>			   
							</div>
						</li>					              
				   </ul>
			   </div><!-- end hero-slider -->				   
		...
		<div class="row mobile-no-padding">      	
			<div class="service-list bgrid-third s-bgrid-half tab-bgrid-whole group">
				...
				<div class="bgrid">	              
					<h3>Mixing.</h3> 
					<div class="service-content">	                  
						<p>If you do not have any idea on how to place sounds in the track properly - you need the mixing. This process is more important in the audio production and requires more attention and time. Usually, after mixing, we will show you the result already with mastering. Working time - is about 3-4 business days. It will be nice if you include in this archive YOUR mixed version.</p> 
		            </div>
				</div> <!-- end bgrid -->
	...
	<div class="row items">
		...
		<!-- checklist-wrapper -->
        <div id="why-us-wrapper" class="bgrid-third s-bgrid-third tab-bgrid-half">
		...
		<div id="modal-01" class="popup-modal mfp-hide">
         ...
         <div id="modal-03" class="popup-modal mfp-hide">
		      ...
		      <div class="description-box">
			      <h4>Mixing</h4>
			      <p>If you do not have any idea on how to place sounds in the track properly - you need the mixing. This process is more important in the audio production and requires more attention and time. Usually, after mixing, we will show you the result already with mastering. Working time - is about 3-4 business days...

It will be nice if you include in this archive YOUR mixed version.</p>
               <span class="categories">All instruments should be exported each other into a WAV PCM file, at least 24bit / 44100 kHz.

It is allowed grouping instruments in one group track, but the mixdown will be the best if every instrument channel of your project will be exported in a separate file each. Filenames must be intuitive (for example, channel track with Kick must have a name "01.kick.wav").

Any processing effects / plugins in all of the tracks have to be turned off.
...
Output signal will be between -4 and -6 db.

Less signal is always better
...
A link to download archive you must send us by e-mail smmastering [at] gmail [dot] com with subject “Artist name – mixing” or upload your track on our special page. Please, note in your message "Track BPM. Also, You could send to us a few "reference tracks" of another author, the sound of which is the best for you.
   ...
   <section id="testimonials">
      ...
      <div class="row content flex-container">
         ...
         <div id="testimonial-slider" class="flexslider">
            ...
            <ul class="slides">
               <li>
                  <p>Highly recommended these service! Great job, nice and smooth!
                  </p>
               ...
               <li>                       
                  <p>Sledger Mastering provides great quality masters at reasonable costs. The Customer Service is awesome - as an artist and label manager I am stoked about the speed customer inquiries are worked on and the extraordinary sound quality these guys are offering. Full support!
                  </p>
                  <div class="testimonial-author">
               ...
               <li>                       
                  <p>The first conversation I realized that Sledger is a very responsible man. That makes such a result - high quality of product performed. I will work with that person further!
                  </p>
                  <div class="testimonial-author">
               ...
               <li>                       
                  <p>High quality mastering engineer! Strongly recommend ! Will be back again for sure!
                  </p>
                  <div class="testimonial-author">
   ...
   <section id="terms">
      ...
      <div class="row">
         ...
         <div class="six columns tab-whole right">
            ...
            <p class="lead">Full text of our public offer.
			</p>
